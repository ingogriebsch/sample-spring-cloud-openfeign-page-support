...
import static com.github.ingogriebsch.sample.spring.cloud.openfeign.page.support.PageUtils.match;
...
public class PageUtilsTest {
    ...
    public void match_throws_exception_if_input_is_null() {
        match(null, null);
    }

    @Test
    public void match_returns_matching_list_if_input_is_empty() {
        List<Object> match = match(newArrayList(), of(0, 20));
        assertThat(match).isEmpty();
    }

    @Test
    public void match_returns_matching_list_if_input_is_bigger_as_page_request() {
        int size = 2;
    ...
    @Test
    public void match_returns_matching_list_if_page_request_is_beyond_input() {
        int size = 2;
    ...
    @Test
    public void match_returns_matching_list_if_called_several_times_with_the_same_input() {
    ...
    @Test(expected = NullPointerException.class)
    public void toPage_throws_exception_if_input_is_null() {
        toPage(null, null);
    }
